...
import ru.rosbank.javaschool.finalback.repository.UserRepository;
...
class UserServiceTest {
    ...
    void loadUserByUsername() {
        ...
        UserEntity user = new UserEntity(1, "Petya", "petya", "password", "petya@mail.ru", null, List.of(new SimpleGrantedAuthority("ROLE_USER")), false, false, false, false);
    ...
    void save() {
        ...
        UserSaveRequestDto dto = new UserSaveRequestDto(0, "Petya", "petya", "password", "petya@mail.ru", null);
        UserEntity user = new UserEntity(0, "Petya", "petya", "password", "petya@mail.ru", null, List.of(new SimpleGrantedAuthority("ROLE_USER")), true, true, true, true);
        UserEntity expected = new UserEntity(1, "Petya", "petya", "password", "petya@mail.ru", null, List.of(new SimpleGrantedAuthority("ROLE_USER")), true, true, true, true);
    ...
    void getAll() {
        ...
        UserEntity user = new UserEntity(1, "Petya", "petya", "password", "petya@mail.ru", null, List.of(new SimpleGrantedAuthority("ROLE_USER")), true, true, true, true);
        List<UserEntity> list = new ArrayList<>();
        list.add(user);

        when(repoMock.findAll()).thenReturn(list);

        UserProfileResponseDto dto = new UserProfileResponseDto(1, "Petya", "petya", "petya@mail.ru", null, List.of(new SimpleGrantedAuthority("ROLE_USER")));
