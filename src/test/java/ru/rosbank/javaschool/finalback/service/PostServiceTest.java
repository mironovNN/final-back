...
import ru.rosbank.javaschool.finalback.exception.NotFoundException;
import ru.rosbank.javaschool.finalback.mapper.PostMapper;
...
class PostServiceTest {
    ...
    void save() {
        ...
        PostResponseDto expected = new PostResponseDto(1, 1, "Petya", LocalDate.now(), "content", "", 0);
    ...
    void getSomePosts() {
        ...
        PostResponseDto dto = new PostResponseDto(1, 1, "Petya", LocalDate.now(), "content", "", 0);
    ...
    void getPostById() {
        ...
        PostResponseDto dto = new PostResponseDto(1, 1, "Petya", LocalDate.now(), "content", "", 1);
